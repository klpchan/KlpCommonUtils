package com.klpchan.commonutils.preference;
...
public class PreferencesUtils {
    ...
    public static String PREFERENCE_NAME = "Klpchan_Preference";

    public static String PREFERENCE_PERSIST_NAME = "Klpchan_Preference_Persist";
     ...
     * @return True if the new values were successfully written to persistent storage.
     */
    public static boolean putPersistBoolean(Context context, String key, boolean value) {
        SharedPreferences settings = context.getSharedPreferences(PREFERENCE_PERSIST_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = settings.edit();
        editor.putBoolean(key, value);
        return editor.commit();
    }
     ...
     */
    public static boolean getPersistBoolean(Context context, String key,boolean defaultValue) {
        SharedPreferences settings = context.getSharedPreferences(PREFERENCE_PERSIST_NAME, Context.MODE_PRIVATE);
	...
	public static void setTwSummaryColorToColorPrimaryDark(Context context, Object object) {
        if (object != null
                && (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M)) {
            if (object instanceof Preference) {
                //((Preference)object).setTwSummaryColorToColorPrimaryDark(true);
            } else if (object instanceof TextView) {
                TypedValue outValue = new TypedValue();
                context.getTheme().resolveAttribute(android.R.attr.colorPrimaryDark, outValue, true);
                if (outValue.resourceId > 0)
                    ((TextView)object).setTextColor(context.getResources().getColor(outValue.resourceId));
            }
        }
    }
